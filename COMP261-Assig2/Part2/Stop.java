 ...
 * Needs to be Comparable in order to be able to order them for input in the
 * interface
 */
...
public class Stop implements Comparable<Stop> {
     ...
     * Display a stop
     * 
     * @return string of the stop information in the format: XXXX: long name at
     *         (lon,lat)
     */
     ...
     * [needed for removing Walking edges]
     */
    public void deleteEdgesInOfType(String type) {
        // remove edges that are of the specified type
     ...
     * [needed for removing Walking edges]
     */
    public void deleteEdgesOutOfType(String type) {
        // remove edges that are of the specified type
