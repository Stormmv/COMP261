            ...
            for (String dataLine : dataLines) {// read in each line of the file
                ...
                if (tokens.length >= 4) {
                    ...
                    if (city1 == null || city2 == null) {
                        ...
                        Edge e = new Edge(city1, city2, capacity, 0, edgeId);
    ...
    public void reportaugmentationPaths(ArrayList<Pair<ArrayList<String>, Integer>> aPaths) {
        if (aPaths != null) {
            ...
            for (Pair<ArrayList<String>, Integer> aPath : aPaths) {
                path.append("AP: ").append(startLocation.getName()).append("[").append(startLocation.getId())
                        .append("]");
                ;
                ...
                for (String eID : aPath.getKey()) {
                    ...
                    path.append(" ").append(nextCity).append("[");
                    String nextCityID = EdmondKarp.getEdge(eID).toCity().getId();
                    path.append(nextCityID).append("]");
                }
            ...
            lineText.setText("No Augmenatation Paths found between " + startLocation.getName() + "["
                    + startLocation.getId() + "] and " + goalLocation.getName() + "[" + goalLocation.getId() + "]");
        }
